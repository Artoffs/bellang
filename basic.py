...
class Parser:
  ...
  def statement(self):
    ...
    if self.current_tok.matches(TT_KEYWORD, 'вяртаць'):
      res.register_advancement()
      self.advance()
    ...
    if self.current_tok.matches(TT_KEYWORD, 'скончыць'):
      res.register_advancement()
      self.advance()
...
class BuiltInFunction(BaseFunction):
  ...
  def execute_extend(self, exec_ctx):
    ...
    if not isinstance(listB, List):
      return RTResult().failure(RTError(
        self.pos_start, self.pos_end,
        "Другі аргумент павінен быць спісам",
        exec_ctx
      ))
